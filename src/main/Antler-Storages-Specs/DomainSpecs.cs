    ...
    {                       
        ...
        public class TestingScenario
        {
            ...
            public void SetUp()
            {
                ...
                Configurator.UseWindsorContainer().UseStorage(NHibernatePlusSqlite.Use.WithMappings(From.AssemblyWithType<NHibernate.Specs.Mappings.CountryMap>().First())).
                                                   UseStorageNamed(EntityFrameworkPlusSqlCe.Use.WithConnectionString("Data Source=TestDB.sdf").WithMappings(From.AssemblyWithType<EntityFramework.Sqlite.Specs.Mappings.CountryMap>().First()), "EF");
